...
// destination lane via currentColor. Same mark for the live puck and the detached ghost.
...
const placed = computed(() =>
  [...inflight.value, ...holding.value, ...parked.value, ...landed.value, ...mia.value].filter((a) => rects.value[a.id]),
);
